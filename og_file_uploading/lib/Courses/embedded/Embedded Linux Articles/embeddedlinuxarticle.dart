...
import '../../embeddedfiles/Embedded Linux Article/linuxariticle.dart';
...
class LinuxArticle extends StatefulWidget {
  LinuxArticle({ super.key});



  @override
  State<LinuxArticle> createState() => _LinuxArticleState();
}

class _LinuxArticleState extends State<LinuxArticle> {
  int selectedIndex = 0;
