...
class OsConcepts extends StatefulWidget {
  OsConcepts({ super.key});



  @override
  State<OsConcepts> createState() => _OsConceptsState();
}

class _OsConceptsState extends State<OsConcepts> {
  int selectedIndex = 0;
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Row(
                    children: [
                      ...
                      new GestureDetector(
                        onTap: (){
                          Navigator.push(context,MaterialPageRoute(builder: (context)=> OsConceptstextbooks()));
                        },
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Row(
                    children: [
                      ...
                      new GestureDetector(
                        onTap: (){
                          Navigator.push(context,MaterialPageRoute(builder: (context)=> OsConceptsppts()));
                        },
                        child: new Text("OS Concepts PPT's ",
                          style: const TextStyle(
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                          ),
