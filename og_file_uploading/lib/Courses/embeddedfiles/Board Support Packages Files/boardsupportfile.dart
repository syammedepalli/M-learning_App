...
class BoardSupportfiles1  extends StatelessWidget{
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          MaterialButton(
              ...
              onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context)=> UploadPdfBoardSupportfiles1()));
              }),
          SizedBox(
            height: 20,
          ),
...
class UploadPdfBoardSupportfiles1 extends StatelessWidget {
...
class loadPdfBoardSupportfiles1 extends StatefulWidget{
  @override

  _loadPdfBoardSupportfiles1State createState() =>_loadPdfBoardSupportfiles1State();
}

class _loadPdfBoardSupportfiles1State extends State<loadPdfBoardSupportfiles1> {
  ...
  Future<void> downloadURLExample() async {
    String downloadURL = await firebase_storage.FirebaseStorage.instance
        .ref('embedded/c-language-Basics/c-programming-tutorial/board1-file.pdf')
        .getDownloadURL();
    print(downloadURL);
