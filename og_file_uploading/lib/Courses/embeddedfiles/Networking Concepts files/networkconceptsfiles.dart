...
class NetworkConceptsfiles1  extends StatelessWidget{
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          MaterialButton(
              ...
              onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context)=> UploadPdfnetworking1()));
              }),
          SizedBox(
            height: 20,
          ),
...
class UploadPdfnetworking1 extends StatelessWidget {
...
class loadPdfnetworking1 extends StatefulWidget{
  @override

  _loadPdfnetworking1State createState() =>_loadPdfnetworking1State();
}

class _loadPdfnetworking1State extends State<loadPdfnetworking1> {
  ...
  Future<void> downloadURLExample() async {
    String downloadURL = await firebase_storage.FirebaseStorage.instance
        .ref('embedded/c-language-Basics/c-programming-tutorial/somes11-file.pdf')
        .getDownloadURL();
    print(downloadURL);
