...
class CompilationProcess extends StatelessWidget{
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          MaterialButton(
              ...
              onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context)=> UploadPdfCompilationProcess()));
              }),
          SizedBox(
            height: 20,
          ),
...
class UploadPdfCompilationProcess extends StatelessWidget {
...
class loadPdfCompilationProcess extends StatefulWidget{
  @override

  _loadPdfCompilationProcessState createState() =>_loadPdfCompilationProcessState();
}

class _loadPdfCompilationProcessState extends State<loadPdfCompilationProcess> {
  ...
  Future<void> downloadURLExample() async {
    String downloadURL = await firebase_storage.FirebaseStorage.instance
        .ref('embedded/c-language-Basics/c-programming-tutorial/some2-file.pdf')
        .getDownloadURL();
    print(downloadURL);
