...
class HomePagett extends StatelessWidget{
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          MaterialButton(
              ...
              onPressed: (){
                Navigator.push(context,MaterialPageRoute(builder: (context)=> UploadPDFcbasic()));
              }),
          SizedBox(
            height: 20,
          ),
...
class UploadPDFcbasic extends StatelessWidget {
...
class loadPdfcbasic extends StatefulWidget{
  @override

  _loadPdfcbasicState createState() =>_loadPdfcbasicState();
}

class _loadPdfcbasicState extends State<loadPdfcbasic> {
  ...
  Future<void> downloadURLExample() async {
    String downloadURL = await firebase_storage.FirebaseStorage.instance
        .ref('embedded/c-language-Basics/c-programming-tutorial/some1-file.pdf')
        .getDownloadURL();
    print(downloadURL);
